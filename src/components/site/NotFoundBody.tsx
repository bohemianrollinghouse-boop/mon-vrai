...
/*
 * Le contenu de la page 404, sans coquille. Il sert à deux endroits qui ne sont pas
 * enveloppés pareil : la 404 du groupe `(site)`, qui hérite déjà du bandeau, de
 * l'en-tête et du pied de page, et la 404 racine, qui doit les remettre à la main.
 */
