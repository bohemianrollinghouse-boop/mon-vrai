...
const APPEARANCE: Appearance = {
  ...
  rules: {
    ...
    ".Tab": { padding: "10px 16px", borderRadius: "999px", border: "none", fontWeight: "600" },
    ".Tab--selected": { backgroundColor: "#111111", color: "#ffffff" },
    ".Tab--selected:hover": { backgroundColor: "#111111", color: "#ffffff" },
