...
function tplOnRevient(c: RenderCtx): string {
  ...
  const theme = (k: string, def: string) => panel(T(c, k, def, `font-size:14px;font-weight:700;color:${INK}`), "#fff", "14px 16px", 14);
