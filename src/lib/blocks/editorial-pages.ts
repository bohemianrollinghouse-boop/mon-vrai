  ...
  const content: BlockDocument["content"] = [
    ...
    block("Chapitre", {
      ...
      paragraphes: lines(
        ...
        "Alors, faute de trouver ces supports, nous les avons fabriqués : des éléments du quotidien photographiés ou sélectionnés, imprimés en petites cartes, plastifiés. Des cartes à regarder, nommer, associer. À ce stade, il n'existait ni Mon Vrai, ni imagier édité, ni projet de marque.",
      ),
    }),
    ...
    block("Chapitre", {
      ...
      paragraphes: lines(
        "Quelques années plus tard, une deuxième petite fille arrive, et les outils numériques sont devenus plus accessibles. Les fichiers deviennent plus aboutis, et l'idée change d'échelle : plutôt que d'imprimer des cartes à la maison, pourquoi ne pas faire fabriquer de vrais livres ? Une formation autour du dropshipping, finalement abandonnée, avait laissé un savoir-faire utile : chercher des fournisseurs, les contacter, comprendre la fabrication, et réfléchir au passage d'une idée à un produit réel.",
        "Dès les premiers essais, les principes étaient là : des représentations réalistes, un fond blanc, très peu d'éléments par livre, aucun texte, une seule image à observer à la fois, une construction volontairement épurée. Les premiers éléments, des fruits et des légumes, ont été photographiés à la maison ; faute de studio, des outils d'intelligence artificielle ont servi à en homogénéiser la lumière, puis chaque élément a été isolé sur fond blanc.",
        "Chaque livre a été volontairement limité à six représentations. Pas vingt, pas cinquante : six. Retirer plutôt qu'ajouter, ne pas remplir pour remplir, et laisser au tout-petit un support visuel simple. Un fruit qui ressemble à un vrai fruit. Un animal qui ressemble réellement à l'animal dont on lui parle. Un objet qui rappelle celui qu'il voit dans sa maison.",
        "La famille partageait déjà beaucoup son quotidien sur les réseaux sociaux, notamment sa vie en bus aménagé. Le projet a suscité de l'intérêt, et de premiers prototypes ont été fabriqués.",
        "Créés d'abord pour une enfant, ils ont plu à d'autres parents et à des personnes intéressées par le développement de l'enfant. Le manque ressenti n'était probablement pas le nôtre seulement.",
      ),
    }),
    ...
    block("Chapitre", {
      ...
      paragraphes: lines(
        "Faire fabriquer et éditer ces livres a demandé d'entrer dans un univers inconnu : chercher des fournisseurs, comprendre la fabrication, se renseigner sur les normes, effectuer les démarches nécessaires pour transformer des fichiers en véritables livres. La structure éditoriale est née à ce moment-là sous le nom de Bohemian Rolling House, qui correspondait déjà à notre univers sur les réseaux sociaux.",
        "En 2025, une campagne Ulule a permis de tester le projet plus sérieusement : une soixantaine de précommandes, puis une production de 500 exemplaires. Ces 500 livres se sont vendus en quelques mois, environ quatre. Au départ, les acheteurs venaient de notre communauté. Puis des commandes sont arrivées de personnes qui ne nous suivaient pas : des parents qui découvraient les imagiers par d'autres, des créateurs de contenu qui les montraient, des professionnels de la petite enfance qui s'y intéressaient.",
      ),
    }),
    ...
    block("Chapitre", {
      ...
      paragraphes: lines(
        "Au départ, les livres s'appelaient Mes Vrais Imagiers. Ce nom décrivait bien les premiers produits, mais il limitait le projet aux imagiers, alors que l'ambition était déjà plus grande : des cartes contrastées, d'autres collections, des supports de langage, des jeux, d'autres outils pensés pour le développement du jeune enfant.",
        "Mon Vrai imagier. Mon Vrai jeu. Mes vraies cartes. Mon Vrai support.",
        ...
        "Les nouveaux imagiers ne sont pas le résultat de nos seuls goûts. Une enquête a été adressée à des parents, des assistantes maternelles, des professionnels de crèche, des personnes ayant déjà acheté les livres et d'autres qui découvraient le projet. 128 personnes ont répondu. Leurs réponses ont confirmé plusieurs valeurs déjà présentes dans Mon Vrai (le réalisme, la simplicité, la solidité, l'adaptation à l'âge, l'intérêt de supports qui évoluent avec l'enfant) et ont guidé le choix des prochains thèmes.",
      ),
    }),
    ...
    block("Chapitre", {
      ...
      paragraphes: lines(
        "Aujourd'hui, Mon Vrai ne se limite plus à cinq livres. L'ambition est de construire une grande collection de référence pour les tout-petits, puis une continuité pour les enfants qui grandissent : des imagiers 6–18 mois, des collections 18–36 mois, des cartes contrastées adaptées aux premiers mois, des supports de langage, des histoires réalistes, des outils autour des émotions.",
        "Nous ne voulons pas créer un produit simplement parce qu'il est joli ou parce qu'il peut se vendre. La question que nous gardons au centre de chaque création est celle-ci : de quoi l'enfant a-t-il besoin à ce moment de son développement, et quel support pouvons-nous imaginer autour de ce besoin ?",
        "À long terme, nous aimerions que Mon Vrai devienne une référence pour les parents et les professionnels qui cherchent les premiers livres de leur enfant : retrouver plusieurs collections en librairie, être utilisé en crèche et chez les assistantes maternelles, créer une continuité pour les plus grands sans perdre la même ligne directrice — partir du réel, et penser d'abord au besoin de l'enfant. Des références comme Tana Hoban pour les premiers mois, ou Céline Alvarez dans son travail autour du langage et de la lecture, ont nourri cette réflexion : un support très simple peut être profondément pensé.",
        "Un enfant qui vit en ville ne rencontrera peut-être jamais une vache dans son quotidien. Mais si on lui parle d'une vache, nous voulons qu'il puisse découvrir dans son livre à quoi elle ressemble réellement. Il aura toute sa vie pour rencontrer l'imaginaire. Le monde réel est déjà immense à découvrir.",
      ),
    }),
