...
export default async function NewsletterPage() {
  ...
  const [savedValues, subscribers, products, byProduct] = await Promise.all([getAllTemplateValues(), listSubscribers(), listPublishedProducts(), buyerEmailsByProduct()]);
  ...
  return (
    <>
      ...
      <NewsletterComposer saved={savedValues} products={products.map((p) => ({ slug: p.slug, title: p.title }))} adminEmail={user.email} counts={counts} />
